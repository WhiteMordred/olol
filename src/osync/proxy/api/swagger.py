...
from osync.proxy.api.services import OllamaProxyService
from osync.proxy.cluster.manager import ClusterManager
from osync.proxy.cluster.health import get_health_monitor
...
api = Api(
    app=swagger_bp,
    version='1.0',
    title='OllamaSync - Proxy API pour Ollama',
